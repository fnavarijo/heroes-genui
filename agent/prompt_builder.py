...
[
  ...
  {{ "surfaceUpdate": {{
    ...
    "components": [
      ...
      {{ "id": "template-image-1", "component": {{ "Image": {{ "url": {{ "path": "/items/0/image" }} }} }} }},
      ...
      {{ "id": "template-editorial-1", "component": {{ "Text": {{ "text": {{ "path": "/items/0/editorial" }} }} }} }},
      {{ "id": "template-fact-1", "component": {{ "Text": {{ "usageHint": "caption", "text": {{ "path": "/items/0/funFact" }} }} }} }},
      {{ "id": "template-view-button-1", "component": {{ "Button": {{ "child": "view-details-text-1", "primary": true, "action": {{ "name": "view_hero", "context": [ {{ "key": "heroName", "value": {{ "path": "/items/0/name" }} }} ] }} }} }} }},
      ...
      {{ "id": "template-image-2", "component": {{ "Image": {{ "url": {{ "path": "/items/1/image" }} }} }} }},
      ...
      {{ "id": "template-editorial-2", "component": {{ "Text": {{ "text": {{ "path": "/items/1/editorial" }} }} }} }},
      {{ "id": "template-fact-2", "component": {{ "Text": {{ "usageHint": "caption", "text": {{ "path": "/items/1/funFact" }} }} }} }},
      {{ "id": "template-view-button-2", "component": {{ "Button": {{ "child": "view-details-text-2", "primary": true, "action": {{ "name": "view_hero", "context": [ {{ "key": "heroName", "value": {{ "path": "/items/1/name" }} }} ] }} }} }} }},
...
if __name__ == "__main__":
    ...
    hero_prompt = get_ui_prompt(my_base_url, HERO_UI_EXAMPLES)
    print(hero_prompt)
